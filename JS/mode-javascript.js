ace.define("ace/mode/doc_comment_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
    ...
    var JavaScriptHighlightRules = function(options) {
        var keywordMapper = this.createKeywordMapper({
            "variable.language":
                "PDEC|PINST|Array|Boolean|Program|Date|Function|Iterator|Number|Object|RegExp|String|Proxy|"  + // Constructors
                ...
                "JSON|Math|"                                                               + // Other
                "this|arguments|prototype|window|document|Begin|End"                                 , // Pseudo
            "keyword":
                "const|yield|import|get|set|async|await|" +
                "break|case|catch|continue|default|delete|DO|ELSE|finally|FOR|ENDFOR|function|" +
                "IF|in|of|instanceof|new|return|switch|throw|try|typeof|let|var|WHILE|with|debugger|" +
                "__parent__|__count__|escape|unescape|with|__proto__|" +
                "class|enum|extends|super|export|implements|private|public|interface|package|protected|static",
            "storage.type":
                "const|let|var|function|Pint|Pfloat",
            "constant.language":
